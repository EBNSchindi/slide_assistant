"""
Presentation Strategist Agent (Google) - Plans component layout and structure

Agent 2 of 3 in the new pipeline (Google Gemini version):
...
class PresentationStrategistAgentGoogle:
    """Recommends optimal component layout and structure using Google Gemini"""
...
"""
    ...
    def plan(
        ...
        """
        Plan slide layout and component structure using Google Gemini
...
Output a SlideBlueprint as JSON with components and layout."""
        ...
        try:
            ...
            raise Exception(f"PresentationStrategistGoogle error: {str(e)}")
    ...
    def replan(
        ...
        """
        Adjust blueprint based on feedback from Agent 3 using Google Gemini
...
Please adjust the components or layout to address the feedback. Return updated blueprint as JSON."""
        ...
        try:
            ...
            adjusted_blueprint = json.loads(content)

            return adjusted_blueprint

        except Exception as e:
            raise Exception(f"PresentationStrategistGoogle replan error: {str(e)}")
