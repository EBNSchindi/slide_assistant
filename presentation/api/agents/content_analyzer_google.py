"""
Content Analyzer Agent (Google) - Analyzes user input and returns ContentBlocks + SlideIntent

Agent 1 of 3 in the new pipeline (Google Generative AI version):
- Input: Raw user text
...
class ContentAnalyzerAgentGoogle:
    """Analyzes user input and structures it into ContentBlocks using Google Gemini"""
...
"""
    ...
    def analyze(self, user_input: str) -> Dict[str, Any]:
        """
        Analyze user input and return SlideIntent + ContentBlocks using Google Gemini
...
Return valid JSON with slide_intent and content_blocks."""
        ...
        try:
            ...
            raise Exception(f"ContentAnalyzerGoogle error: {str(e)}")
