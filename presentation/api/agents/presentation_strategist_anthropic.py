"""
Presentation Strategist Agent (Anthropic) - Plans component layout and structure

Agent 2 of 3 in the new pipeline using Anthropic Claude API:
...
class PresentationStrategistAgentAnthropic:
    """Recommends optimal component layout and structure using Anthropic Claude API"""
...
"""
    ...
    def plan(
        ...
        """
        Plan slide layout and component structure using Anthropic Claude API
...
Output a SlideBlueprint as JSON with components and layout."""
        ...
        try:
            ...
            raise Exception(f"PresentationStrategistAgentAnthropic error: {str(e)}")
...
Please adjust the components or layout to address the feedback. Return updated blueprint as JSON."""
        ...
        try:
            ...
            raise Exception(f"PresentationStrategistAgentAnthropic replan error: {str(e)}")
